<template>
  <Teleport to="body">
    <div tabindex="-1" aria-hidden="true" class="text-white overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-[calc(100%-1rem)] max-h-full flex items-center justify-center">
